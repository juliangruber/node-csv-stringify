...
var Stringifier, get, replace, stream, util;
...
Stringifier.prototype.stringify = function(line) {
  var _line, column, columns, containsEscape, containsLinebreak, containsQuote, containsdelimiter, delimiter, escape, field, i, j, l, newLine, quote, quoteBuf, ref, ref1, shouldQuote, value;
  ...
  if (Array.isArray(line)) {
    ...
    for (i = l = 0, ref1 = line.length; 0 <= ref1 ? l < ref1 : l > ref1; i = 0 <= ref1 ? ++l : --l) {
      ...
      if (typeof field === 'string') {
        ...
        field = Buffer(this.options.formatters.bool(field));
      } else if (field instanceof Date) {
        field = Buffer(this.options.formatters.date(field));
      } else if (typeof field === 'object' && field !== null && !Buffer.isBuffer(field)) {
        field = Buffer(this.options.formatters.object(field));
      }
